...
const LaunchCard = ({ project }) => {
  const { mission_name, details, launch_date_local } = project;
  ...
  return (
    <div className="card flex py-12 relative bg-[#151515] p-4 border-2 border-fuchsia-500 rounded-xl w-full max-w-4xl mx-auto">
      <div className="card__image -translate-x-24 bg-slate-50 h-52 w-full max-w-[15rem]    relative rounded overflow-hidden">
        <Image
      ...
      <div className="card__body -translate-x-12 font-gafata text-[#929292]">
